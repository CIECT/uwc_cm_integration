...
public class Download_Students_Output  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.uwc.ac.za/", "Download_Students_Output"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.uwc.ac.za/", "Student_List"));
